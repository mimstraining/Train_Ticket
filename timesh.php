    ...
    <div class="header_resize">
      <div class="menu_nav">
        <ul>
          ...
          <li class="active"><a href="timesh.php"><span>Time Shedule</span></a></li>
...
if ($result->num_rows > 0) {
    echo "<table><tr><th>Train ID</th><th>Train No</th><th> Name of Train </th><th> Starting Station </th><th>Starting Time</th><th>Arrival Station</th><th>Arrival Time</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<center><tr><td>".$row["ID"]."</td><td>".$row["train_no"]."</td><td>".$row["train_name"]."</td><td> ".$row["s_station"]."</td><td> ".$row["s_time"]."</td><td> ".$row["a_station"]."</td><td> ".$row["a_time"]."</td></tr></center>";
    }
    echo "</table>  ";
