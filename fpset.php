...
<div class="main">
  ...
  <div class="content">
    <div class="content_resize">
      <div class="mainbar">
        <div class="article">
          <h2><span><?php echo "Wellcome ".$_SESSION['sess_name'].",your User Name & Email match with datadase.Now enter a new password. "?></span></h2>
          ...
          <form method="POST" id="" target="_self">
            <ol>
              <li>
                ...
                <input type="Password"  id="email" name="pass" class="text" /> 
              <li>
              <input type="Submit" value="Reset" name="btn" class="send">
                <div class="clr"></div>
              </li>
            </ol>
          </form>
    ...
    if(isset($_POST['btn'])){
        ...
        $q = mysql_query("UPDATE register SET password='$pass' WHERE name ='".$_SESSION['sess_name']."'");
        if($q){
