...
if ($result->num_rows > 0) {
    ...
    echo "<table><tr><th>Train No </th><th>Train Name </th><th>Dparture Time </th><th>Arrival Time </th><th>Class</th><th>Action</th></tr>";
    // output data of each row
    while($row = $result->fetch_assoc()) {
        echo "<center><tr>
              <th>".$row["train_no"]."</th>
              <th>".$row["train_name"]."</th>
              <th>".$row["s_time"]."</th>
              <th>".$row["a_time"]."</th>
              <th>".$_SESSION['sess_class']." </th>
              <th> <a href='reserv.php'>Reservation</a></th>
              </tr></center>";
    }
    echo "</table>";
